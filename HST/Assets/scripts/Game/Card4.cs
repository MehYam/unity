...
public abstract class AbstractAbility
{
    ...
    public AbstractAbility(int id, string name, string text, int cost)
    {
        this.id = id;
        this.name = name;
        this.text = text;
...
public class MinionCard : AbstractAbility
{
...
public class ModifiedAbility<T> where T : AbstractAbility
{
...
public class AbilityFactory
{
    ...
    int _instances = 0;
    public AbstractAbility CreateAbility(int id) 
    {
        return null;
    }
